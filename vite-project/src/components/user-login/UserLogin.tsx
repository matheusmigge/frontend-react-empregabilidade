    ...
    return(
        <>
            ...
            <form>
                ...
                <input type="email" id="user-email" name="user-email" placeholder="Digite seu email"/>

                <label htmlFor="user-password">Senha</label>
                <input type="password" id="user-password" name="user-password" placeholder="Digite sua senha"/>
